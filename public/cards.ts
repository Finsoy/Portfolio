import ICard from '../src/components/shared/Interface/ICard'

const cards: [string[], ...ICard[][]] = [
    ['Action (set A)', 'Action (set B)', 'Animal (set A)', 'Animal (set B)', 'Clothes', 'Emotions', 'Fruits (set A)', 'Fruits (set B)'],
    [
        {
            word: 'cry',
            translation: 'плакать',
