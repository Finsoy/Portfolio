...
const RotateIcon = (props: {handleRotateClick: (e: React.MouseEvent<HTMLDivElement>) => void}): JSX.Element => (
        <div className='rotate-icon-wrapper' onClick={props.handleRotateClick}>
            <svg className='rotate-icon' id="svg" xmlns="http://www.w3.org/2000/svg"
                 xmlnsXlink="http://www.w3.org/1999/xlink" width="400" height="400" viewBox="0, 0, 400,400">
                <g id="svgg">
                    <path id="path0"
                          ...
                          stroke="none" fill="#000000" fillRule="evenodd"/>
                </g>
            </svg>
        </div>
    )
